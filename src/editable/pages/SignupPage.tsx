    ...
    <EditableSiteShell>
      <main className="bg-[var(--editable-page-text,#2f1d16)] text-[var(--editable-page-bg,#fff4e4)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
          <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.08] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] backdrop-blur sm:p-8">
            ...
            <div className="mt-8 grid max-w-xl gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={label} className="rounded-[1rem] border border-white/10 bg-white/[0.07] p-4">
                  ...
                  <p className="mt-3 text-sm font-black leading-5 text-white">{label}</p>
                </div>
              ))}
            </div>
          </div>
